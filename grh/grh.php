...
<link href="../css/grh.css" rel="stylesheet">
   ...
   <div id="container">
      ...
      <div id="frminsc">
         ...
         <div id="wb_btn_connexionm">
            <a href="./../administrator/update_pass.php"><div id="btn_connexionm"><div id="btn_connexionm_text"><span id="wb_uid4"><strong>Change passe</strong></span></div></div></a></div>
         <div id="wb_txtphys">
            <div id="wb_uid5"><span id="wb_uid6">ler dans l'au - dela . j ai couler les larmes mais Nous tes amis </span></div>
            <div id="wb_uid7"><span id="wb_uid8">nous prions ALLAH de te pardonner tes manquements de </span></div>
            <div id="wb_uid9"><span id="wb_uid10">t'accorder l'un des Paradis que nous avions etudiez ce jour. </span></div>
            <div id="wb_uid11"><span id="wb_uid12">QU'ALLAH T ACCORDE SON PARADIS ETERNEL POUR </span></div>
            <div id="wb_uid13"><span id="wb_uid14">L'ETERNITE. RIP</span></div>
         </div>
         <div id="wb_Text2">
            <span id="wb_uid15">Nom:</span></div>
         <div id="wb_Text3">
            <span id="wb_uid16">Prénom:</span></div>
         <div id="wb_btn_connexionp">
            <a href="./../administrator/update_email.php"><div id="btn_connexionp"><div id="btn_connexionp_text"><span id="wb_uid17"><strong>Changer email</strong></span></div></div></a></div>
         <div id="wb_Shape1">
            <a href="./../incription/insmoral.php"><div id="Shape1"><div id="Shape1_text"><span id="wb_uid18"><strong>Gestionnaire</strong></span></div></div></a></div>
         <div id="wb_Text4">
            <span id="wb_uid19">Email:</span></div>
      ...
      <div id="Layer2">
         ...
         <div id="wb_Text1">
            <span id="wb_uid20">Lodin:</span></div>
      </div>
   </div>
<script src="../java-script/grh.js"></script>
</body>
</html>