...
<link href="../../css/Primes.css" rel="stylesheet">
   ...
   <div id="container">
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-odnoklassniki">&nbsp;</i>Primes</li>
         </ul>
      </div>
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <label for="" id="Label2">GRH - Primes</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste Primes</h1></div>
            <hr id="Line1">
         </div>
      ...
      <div id="Layer4">
         <div id="wb_Shape1">
            <img src="../../images/img0073.png" id="Shape1" alt=""></div>
         <label for="" id="Label1">Primes</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
