...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <label for="" id="Label2">GRH - Gestionnaires</label>
         <div id="Layer4">
            <div id="wb_Text7">
         ...
         <div id="Layer6">
            ...
            <input type="text" id="Editbox5" name="gestion" value="Gestion clients" tabindex="1" readonly="" autocomplete="off" placeholder="Gestion clients">
            <input type="text" id="Editbox6" name="fonction" value="Gestionnaire" tabindex="1" readonly="" autocomplete="off" placeholder="Fonction*">
            <input type="text" id="Editbox7" name="poste" value="Gestions" tabindex="1" readonly="" autocomplete="off" placeholder="Poste*">
         </div>
