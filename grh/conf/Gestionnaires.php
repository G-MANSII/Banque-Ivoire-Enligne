...
<link href="../../css/Gestionnaires.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <label for="" id="Label2">Base de données - Gestionnaires</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste Gestionnaires</h1></div>
            <hr id="Line1">
         </div>
         ...
         <div id="wb_btn_connexionp">
            <a href="./../../administrator/update_email.php" onclick="$('#modal').dialog('open');return false;"><div id="btn_connexionp"><div id="btn_connexionp_text"><span id="wb_uid48"><strong>Modifier</strong></span></div></div></a></div>
      </form>
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-ship">&nbsp;</i>Gestionnaires</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0099.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Gestionnaires</label>
      </div>
      ...
      <div id="Div">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid49"><span id="wb_uid50"><a href="./../../administrator/conf/Categorie_de_poste.php">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
