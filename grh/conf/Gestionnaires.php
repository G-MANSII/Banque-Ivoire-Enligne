   ...
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <div id="wb_btn_connexionp">
            <a href="./../../administrator/update_email.php" onclick="ShowObject('modal', 1);return false;"><div id="btn_connexionp"><div id="btn_connexionp_text"><span id="wb_uid48"><strong>Modifier</strong></span></div></div></a></div>
      </form>
