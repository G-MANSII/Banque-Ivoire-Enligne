...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="Nom" value="" tabindex="1" placeholder="Titre contrat">
         <label for="" id="Label2">GRH - Contrats</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste Contrats</h1></div>
            <hr id="Line1">
         </div>
         <input type="date" id="Editbox1" name="date" value="" tabindex="1" placeholder="Date d&#39;embauche">
         <input type="date" id="Editbox2" name="date" value="" tabindex="1" placeholder="Date licenciement">
         <textarea name="TextArea1" id="TextArea1" rows="8" cols="51" placeholder="Raisons"></textarea>
         <table id="Table1">
            <tr>
         ...
         <select name="employer" size="1" id="ContratsCombobox1">
            <option selected="" value="Employés">Employés</option>
         </select>
      </form>
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-odnoklassniki">&nbsp;</i>Contrats</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0081.png" id="Shape2" alt=""></div>
