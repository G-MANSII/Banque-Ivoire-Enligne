...
<link href="../../css/Feries.css" rel="stylesheet">
   ...
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste Feriés</h1></div>
            <hr id="Line1">
         </div>
         <input type="submit" id="Button1" name="modifier" value="Modifier">
         <input type="text" id="Editbox1" name="date" value="" tabindex="1" placeholder="Date du jour">
         <div id="wb_Text6">
            <div id="wb_uid0"><span id="wb_uid1">Fixe&nbsp;?:</span></div>
         </div>
         <select name="titre" size="1" id="Combobox1" tabindex="0">
            <option value="oui">Oui</option>
            <option value="non">Non</option>
         </select>
         <div id="wb_Text1">
            <div id="wb_uid2"><span id="wb_uid3">Payé&nbsp;?:</span></div>
         </div>
         <select name="titre" size="1" id="Combobox2" tabindex="0">
            <option value="oui">Oui</option>
            <option value="non">Non</option>
         </select>
         <table id="Table1">
            <tr>
               <td class="cell0"><span id="wb_uid4"> Non du jour</span></td>
               <td class="cell0"><span id="wb_uid5">Date du jour</span></td>
               <td class="cell0"><span id="wb_uid6"> Fixe</span></td>
               <td class="cell1"><span id="wb_uid7"> Payé</span></td>
            </tr>
            <tr>
               <td class="cell2"><span id="wb_uid8"> </span></td>
               <td class="cell2"><span id="wb_uid9"> </span></td>
               <td class="cell2"><span id="wb_uid10"> </span></td>
               <td class="cell3"><span id="wb_uid11"> </span></td>
            </tr>
            <tr>
               <td class="cell2"><span id="wb_uid12"> </span></td>
               <td class="cell2"><span id="wb_uid13"> </span></td>
               <td class="cell2"><span id="wb_uid14"> </span></td>
               <td class="cell3"><span id="wb_uid15"> </span></td>
            </tr>
            <tr>
               <td class="cell2"><span id="wb_uid16"> </span></td>
               <td class="cell2"><span id="wb_uid17"> </span></td>
               <td class="cell2"><span id="wb_uid18"> </span></td>
               <td class="cell3"><span id="wb_uid19"> </span></td>
            </tr>
            <tr>
               <td class="cell2"><span id="wb_uid20"> </span></td>
               <td class="cell2"><span id="wb_uid21"> </span></td>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-odnoklassniki">&nbsp;</i>Feri&#233;s</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0087.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Feriés</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
            ...
            <div id="wb_local">
               <div id="wb_uid24"><span id="wb_uid25"><a href="./../../agences/">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
               <div id="icolocal"><i class="fa fa-map-marker">&nbsp;</i></div></div>
            <div id="wb_txtacc">
               <div id="wb_uid26"><span id="wb_uid27"><em>La banque en ligne faite pour vous&nbsp;!</em></span></div>
            </div>
            <div id="wb_logo">
