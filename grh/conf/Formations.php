   ...
   <div id="container">
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-odnoklassniki">&nbsp;</i>Formations</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0069.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Formations</label>
      </div>
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="formation" value="" tabindex="1" placeholder="Formation">
         <label for="" id="Label2">GRH - Permissions</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <input type="email" id="Editbox4" name="typr" value="" tabindex="1" placeholder="TYPE">
         ...
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste Formations</h1></div>
            <hr id="Line1">
         </div>
      ...
      <div id="Layer5">
         <div id="wb_Shape1">
            <img src="../../images/img0070.png" id="Shape1" alt=""></div>
         <label for="" id="Label1">Formations</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
