...
<link href="../../css/Certificats.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <label for="" id="Label2">Base de données - Certificats</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste Certificats</h1></div>
            <hr id="Line1">
         </div>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-odnoklassniki">&nbsp;</i>Certificats</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0068.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Certificats</label>
      </div>
      <div id="Div">
         <div id="head">
            <div id="wb_band">
