   ...
   <div id="container">
      ...
      <div id="zone">
         <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
            ...
            <label for="" id="Label2">Base de données - Emplois</label>
            <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
            <div id="Layer3">
               <hr id="Line2">
               <div id="wb_Heading1">
                  <h1 id="Heading1">Liste Emplois</h1></div>
               <hr id="Line1">
            </div>
         ...
         <div id="wb_Breadcrumb2">
            <ul id="Breadcrumb2">
               ...
               <li class="active"><i class="fa fa-odnoklassniki">&nbsp;</i>Emplois</li>
            </ul>
         </div>
         <div id="Layer2">
            <div id="wb_Shape2">
               <img src="../../images/img0084.png" id="Shape2" alt=""></div>
            <label for="" id="Label3">Emplois</label>
         </div>
      </div>
      <div id="Div">
         <div id="head">
