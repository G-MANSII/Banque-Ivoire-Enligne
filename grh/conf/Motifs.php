...
<link href="../../css/Motifs.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="Nom" value="" tabindex="1" placeholder="Nom motif">
         <label for="" id="Label2">Base de données - Motifs</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste Motifs</h1></div>
            <hr id="Line1">
         </div>
         <table id="Table1">
            <tr>
         ...
         <input type="text" id="Editbox3" name="type" value="" tabindex="1" placeholder="Type motif">
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-odnoklassniki">&nbsp;</i>Motifs</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0090.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Motifs</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
