...
<link href="../css/grh_email.css" rel="stylesheet">
   ...
   <div id="container">
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li><a href="./grh.php" title="Gestionnaire des resources humaines"><i class="fa fa-slideshare">&nbsp;</i>Gestionnaire des resources humaines</a></li>
            <li class="active"><i class="fa fa-envelope">&nbsp;</i>Changer email</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../images/img0071.png" id="Shape2" alt=""></div>
      ...
      <div id="Divi">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid0"><span id="wb_uid1"><a href="./../agences/">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
