...
<body>
   <div id="container">
      ...
      <div id="Layer1">
         <div id="wb_Form1">
            <form name="contact" method="post" action="mailto:alhassaneo@address.com?subject=Contact Information" id="Form1">
               ...
               <input type="text" id="Editbox1" name="nom" value="" tabindex="1" placeholder="Nom*">
               <input type="text" id="Editbox2" name="prenom" value="" tabindex="1" placeholder="Pr&#233;nom*">
      ...
      <div id="Layer2">
         ...
         <label for="" id="Label8">Contactez-nous</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
