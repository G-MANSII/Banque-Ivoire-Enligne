...
<link href="../../css/climoral.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <div id="Layer4">
         <div id="wb_Shape2">
            <img src="../../images/img0090.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Ouverture de compte</label>
      </div>
      <form name="form" method="post" action="" enctype="text/plain" id="Layer2">
         <label for="" id="Label4">Identification moral - Documents</label>
         <div id="Layer6">
            <div id="wb_Text21">
               <div id="wb_uid0"><span id="wb_uid1">Pièces d'identification:</span></div>
            </div>
            <div id="wb_Text23">
            ...
            <div id="wb_Text30">
               <div id="wb_uid8"><span id="wb_uid9">Régistre de commerce</span></div>
            </div>
            <input type="file" id="FileUpload5" name="FileUpload1">
            <div id="wb_Text20">
               <div id="wb_uid10"><span id="wb_uid11">Document de la Sociéte</span></div>
            </div>
            <input type="file" id="FileUpload6" name="FileUpload1">
            <div id="wb_Text31">
               <div id="wb_uid12"><span id="wb_uid13">Autre document legislatif</span></div>
            </div>
         </div>
      </form>
      ...
      <div id="Divi">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid14"><span id="wb_uid15"><a href="./../../agences/">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
               <div id="icolocal"><i class="fa fa-map-marker">&nbsp;</i></div></div>
            <div id="wb_txtacc">
               <div id="wb_uid16"><span id="wb_uid17"><em>La banque en ligne faite pour vous&nbsp;!</em></span></div>
            </div>
            <div id="wb_logo">
