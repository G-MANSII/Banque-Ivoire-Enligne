...
<link href="../css/inscrit_physiq.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <div id="Layer2">
         ...
         <div id="wb_Text9">
            <div id="wb_uid12"><span id="wb_uid13">Tous les champs doivent être correctement remplis sous penne d'être rejeté.</span></div>
         </div>
         <div id="Layer1">
            <div id="wb_Text6">
               <div id="wb_uid14"><span id="wb_uid15">Titre: </span></div>
            </div>
            ...
            <div id="wb_Text3">
               <div id="wb_uid16"><span id="wb_uid17">CNI</span></div>
            </div>
            ...
            <div id="wb_Text4">
               <div id="wb_uid18"><span id="wb_uid19">Passeport</span></div>
            </div>
            <div id="wb_Text5">
            ...
            <div id="wb_Text16">
               <div id="wb_uid26"><span id="wb_uid27"><strong><u>Identification client - Informations personnelles </u></strong></span></div>
            </div>
            <div id="wb_Text18">
