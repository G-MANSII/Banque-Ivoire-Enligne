   ...
   <div id="container">
      ...
      <div id="Layer2">
         ...
         <div id="Layer3">
            ...
            <input type="text" id="Editbox2" name="edtnam" value="" tabindex="1" placeholder="Titre*">
            <input type="text" id="Editbox3" name="edtprenom" value="" tabindex="2" placeholder="Nom social*">
      ...
      <div id="Layer4">
         <div id="wb_Shape2">
            <img src="../images/img0107.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Ouverture de compte</label>
      </div>
      <input type="text" id="Editbox5" name="edtnam" value="" tabindex="1" placeholder="Nom*">
      <div id="Div">
         <div id="head">
            <div id="wb_band">
            ...
            <div id="wb_local">
               <div id="wb_uid10"><span id="wb_uid11"><a href="./../administrator/conf/Categorie_de_poste.php">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
