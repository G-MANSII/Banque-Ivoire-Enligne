   ...
   <div id="container">
      ...
      <div id="Div">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid7"><span id="wb_uid8"><a href="./../administrator/conf/Categorie_de_poste.php">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
               <div id="icolocal"><i class="fa fa-map-marker">&nbsp;</i></div></div>
            <div id="wb_txtacc">
               <div id="wb_uid9"><span id="wb_uid10"><em>La banque en ligne faite pour vous&nbsp;!</em></span></div>
            </div>
            <div id="wb_logo">
