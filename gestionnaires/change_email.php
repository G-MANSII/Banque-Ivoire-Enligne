...
<link href="../css/change_email.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="email" id="edtpass" name="newmail1" value="" tabindex="2" placeholder="Nouveau email*">
         ...
         <input type="email" id="Editbox1" name="newmail2" value="" tabindex="3" placeholder="Confirmer nouveau email*">
      </form>
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            <li><a href="./../index.php" title="xx"><i class="fa fa-home">&nbsp;</i>Acceuil</a></li>
            <li><a href="./Gestion.php" title="Gestionnaires"><i class="fa fa-slideshare">&nbsp;</i>Gestionnaires</a></li>
            <li class="active"><i class="fa fa-envelope">&nbsp;</i>Changer email</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../images/img0077.png" id="Shape2" alt=""></div>
