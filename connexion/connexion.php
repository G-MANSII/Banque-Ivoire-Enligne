   ...
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" id="Layer1">
         ...
         <div id="wb_linklogoub">
            <div id="wb_uid0"><span id="wb_uid1"><a href="./updatepass.php">Login oublié&nbsp;?</a></span></div>
         </div>
         <div id="wb_link_passoub">
            <div id="wb_uid2"><span id="wb_uid3"><a href="./updatepass.php">Mot de passe oublié&nbsp;?</a></span></div>
         </div>
      ...
      <div id="Divi">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid4"><span id="wb_uid5"><a href="./../agences/">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
