...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="vcorp">
         ...
         <div id="wb_mem">
            <span id="wb_uid46">Choisir le comptes de prélèvements:</span></div>
         <div id="eeeeee">
            <div id="wb_Heading1">
         ...
         <label for="" id="Label4">Compte</label>
         <select name="titre" size="1" id="Combobox1" tabindex="0">
         </select>
         <div id="wb_txtperi">
            <span id="wb_uid47">Période:</span></div>
         ...
         <textarea name="TextArea1" id="TextArea1" rows="7" cols="31"></textarea>
         <div id="wb_objet">
            <span id="wb_uid48">Objet de emande:</span></div>
         <select name="titre" size="1" id="Combobox3" tabindex="0">
         ...
         <div id="wb_p_et">
            <span id="wb_uid49">Type de prets:</span></div>
         <div id="wb_montan">
            <span id="wb_uid50">Montant:</span></div>
         <input type="text" id="Editbox1" name="Editbox1" value="" autocomplete="off">
         <div id="wb_fcfa">
            <span id="wb_uid51">Fcfa</span></div>
      </form>
      <div id="wb_montantsold">
         <span id="wb_uid52">9.456.832</span>
      </div>
      <div id="wb_nom">
         <span id="wb_uid53">Nom: </span>
      </div>
      <div id="wb_bdtypcompt">
         <span id="wb_uid54">Courant</span>
      </div>
   </div>
</body>
</html>