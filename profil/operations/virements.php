...
<link href="../../css/virements.css" rel="stylesheet">
   ...
   <div id="container">
      <div id="wb_jcrum">
         <ul id="jcrum">
            ...
            <li><a href="./../profil.php" title="Profil"><i class="fa fa-university">&nbsp;</i>Profil</a></li>
         </ul>
      </div>
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="vcorp">
         <input type="text" id="edtlogin" name="Nom" value="" tabindex="1" placeholder="Nom">
         <input type="submit" id="ebtn" name="Validé" value="Validé">
         <div id="wb_e">
            <span id="wb_uid46"><strong><u>Bénéficiaire</u></strong></span></div>
         <div id="Z">
            <div id="wb_Heading1">
         ...
         <input type="text" id="Editbox5" name="prenom" value="" tabindex="1" placeholder="Pr&#233;nom">
         <input type="text" id="Editbox6" name="pays" value="" tabindex="1" placeholder="Pays">
         <input type="text" id="Editbox7" name="Ville" value="" tabindex="1" placeholder="Ville">
         <input type="text" id="Editbox8" name="Numero" value="" tabindex="1" placeholder="Numero">
         <input type="text" id="Editbox9" name="email" value="" tabindex="1" placeholder="Email">
         <input type="text" id="Editbox11" name="Agences" value="" tabindex="1" placeholder="Agence">
         <input type="text" id="Editbox12" name="montant" value="" tabindex="1" placeholder="Montant">
         <input type="text" id="Editbox10" name="Banque" value="" tabindex="1" placeholder="Banque">
         <input type="text" id="Editbox13" name="iban" value="" tabindex="1" placeholder="IBAN">
         <input type="text" id="Editbox14" name="SWIFT" value="" tabindex="1" placeholder="SWIFT">
      </form>
      <div id="wb_montantsold">
         <span id="wb_uid47">9.456.832</span>
      </div>
      <div id="wb_nom">
         <span id="wb_uid48">Nom: </span>
      </div>
      <div id="wb_bdtypcompt">
         <span id="wb_uid49">Courant</span>
      </div>
   </div>
</body>
</html>