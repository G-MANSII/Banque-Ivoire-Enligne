...
<link href="../../css/releves.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="divprinc">
         ...
         <div id="btn_act">
            <div id="wb_btn_connexionp">
               <a href="./virements.php"><div id="btn_connexionp"><div id="btn_connexionp_text"><span id="wb_uid0"><strong>Connexion</strong></span></div></div></a></div>
            <div id="wb_pret">
               <a href="./../../incription/inscrit_physiq.php"><div id="pret"><div id="pret_text"><span id="wb_uid1"><strong>Connexion</strong></span></div></div></a></div>
            <div id="wb_viremen">
               <a href="./releves.php"><div id="viremen"><div id="viremen_text"><span id="wb_uid2"><strong>Connexion</strong></span></div></div></a></div>
         </div>
         <div id="info">
            <div id="wb_photoprofil">
               <img src="../../images/logo.png" id="photoprofil" alt=""></div>
            <div id="wb_agence">
               <span id="wb_uid3">edit</span></div>
            <div id="wb_numero_compt">
               <span id="wb_uid4">edit</span></div>
            <div id="wb_nom">
               <span id="wb_uid5">edit</span></div>
            <div id="wb_prenom">
               <span id="wb_uid6">edit</span></div>
            <div id="wb_type_de_compte">
               <span id="wb_uid7">edit</span></div>
            <div id="wb_derniereseesion">
               <span id="wb_uid8">edit</span></div>
            <div id="wb_sold">
               <span id="wb_uid9">edit</span></div>
         </div>
         <div id="table">
            <table id="Table1">
               <tr>
               ...
               <tr>
                  ...
                  <td class="cell1"><span id="wb_uid27"> </span></td>
               </tr>
               <tr>
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="vcorp">
         ...
         <div id="wb_e">
            <span id="wb_uid30">edit</span></div>
         <div id="Layer1">
            <div id="wb_Heading1">
      ...
      <div id="Div">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid31"><span id="wb_uid32"><a href="./../../administrator/conf/Categorie_de_poste.php">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
               <div id="icolocal"><i class="fa fa-map-marker">&nbsp;</i></div></div>
            <div id="wb_txtacc">
               <div id="wb_uid33"><span id="wb_uid34"><em>La banque en ligne faite pour vous&nbsp;!</em></span></div>
            </div>
            <div id="wb_logo">
