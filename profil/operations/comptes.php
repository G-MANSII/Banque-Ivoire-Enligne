...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="vcorp">
         ...
         <div id="wb_e">
            <span id="wb_uid38"><strong><u>Tous les comptes</u></strong></span></div>
         <div id="Layer1">
            <div id="wb_Heading1">
         ...
         <div id="Layer2">
            <div id="wb_Text1">
               <span id="wb_uid39">Type de compte:</span></div>
            <div id="wb_Text2">
               <span id="wb_uid40">N° de compte:</span></div>
            <div id="wb_Text3">
               <span id="wb_uid41">IBAN</span></div>
            <div id="wb_Text6">
               <span id="wb_uid42">SWITF:</span></div>
         </div>
         <div id="Layer3">
            <div id="wb_Text4">
               <span id="wb_uid43">Type de compte:</span></div>
            <div id="wb_Text5">
               <span id="wb_uid44">N° de compte:</span></div>
            <div id="wb_Text7">
               <span id="wb_uid45">IBAN</span></div>
            <div id="wb_Text8">
               <span id="wb_uid46">SWITF:</span></div>
         </div>
         <div id="Layer4">
            <div id="wb_Text9">
