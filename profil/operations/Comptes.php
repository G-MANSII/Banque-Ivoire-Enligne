...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="vcorp">
         ...
         <div id="wb_e">
            <span id="wb_uid46"><strong><u>Tous les comptes</u></strong></span></div>
         <div id="Layer1">
            <div id="wb_Heading1">
               <h1 id="Heading1">Mes comptes</h1></div>
            <hr id="Line1">
            <hr id="Line2">
         </div>
         <div id="Layer2">
            <div id="wb_Text1">
               <span id="wb_uid47">Type de compte:</span></div>
            <div id="wb_Text2">
               <span id="wb_uid48">N° de compte:</span></div>
            <div id="wb_Text3">
               <span id="wb_uid49">IBAN</span></div>
            <div id="wb_Text6">
               <span id="wb_uid50">SWITF:</span></div>
         </div>
         <div id="Layer3">
            <div id="wb_Text4">
               <span id="wb_uid51">Type de compte:</span></div>
            <div id="wb_Text5">
               <span id="wb_uid52">N° de compte:</span></div>
            <div id="wb_Text7">
               <span id="wb_uid53">IBAN</span></div>
            <div id="wb_Text8">
               <span id="wb_uid54">SWITF:</span></div>
         </div>
         <div id="Layer4">
            <div id="wb_Text9">
               <span id="wb_uid55">Type de compte:</span></div>
            <div id="wb_Text10">
               <span id="wb_uid56">N° de compte:</span></div>
            <div id="wb_Text11">
               <span id="wb_uid57">IBAN</span></div>
            <div id="wb_Text12">
               <span id="wb_uid58">SWITF:</span></div>
         </div>
      </form>
      <div id="wb_montantsold">
         <span id="wb_uid59">9.456.832</span>
      </div>
      <div id="wb_nom">
         <span id="wb_uid60">Nom: </span>
      </div>
      <div id="wb_bdtypcompt">
         <span id="wb_uid61">Courant</span>
      </div>
   </div>
</body>
</html>