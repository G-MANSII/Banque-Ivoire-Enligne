...
<link href="../../css/monnaies.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="d">
         <input type="submit" id="ebtn" name="Validé" value="Validé">
         <div id="divv">
            <div id="wb_h">
               <h1 id="h">Monnaies</h1></div>
            <hr id="k">
            <hr id="éz">
         </div>
         <div id="wb_Text1">
            <span id="wb_uid46">Monnaie actuelle:</span></div>
         <div id="wb_Text2">
            <span id="wb_uid47">F cfa</span></div>
         <div id="wb_Text3">
            <span id="wb_uid48">Selectionner la nouvelle monnaie:</span></div>
         <select name="sexe" size="1" id="Combobox2" tabindex="0" autofocus="">
         </select>
      </form>
      <div id="wb_montantsold">
         <span id="wb_uid49">9.456.832</span>
      </div>
      <div id="wb_nom">
         <span id="wb_uid50">Nom: </span>
      </div>
      <div id="wb_bdtypcompt">
         <span id="wb_uid51">Courant</span>
      </div>
   </div>
</body>
</html>