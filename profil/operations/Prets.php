...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="vcorp">
         ...
         <div id="wb_mem">
            <span id="wb_uid38">Choisir le comptes de prélèvements:</span></div>
         <div id="eeeeee">
            <div id="wb_Heading1">
         ...
         <div id="wb_txtperi">
            <span id="wb_uid39">Période:</span></div>
         ...
         <div id="wb_objet">
            <span id="wb_uid40">Objet de emande:</span></div>
         ...
         <div id="wb_p_et">
            <span id="wb_uid41">Type de prets:</span></div>
         <div id="wb_montan">
            <span id="wb_uid42">Montant:</span></div>
         <input type="text" id="Editbox1" name="Editbox1" value="" autocomplete="off">
         <div id="wb_fcfa">
            <span id="wb_uid43">Fcfa</span></div>
      </form>
   </div>
</body>
</html>