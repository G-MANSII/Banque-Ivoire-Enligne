...
<link href="../../css/mode_reglement.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="mode" value="" tabindex="1" placeholder="Mode de r&#232;glement">
         <label for="" id="Label2">Base de données - Mode de règlement</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <hr id="Line1">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste des Mode de règlement existants</h1></div>
         </div>
         <input type="date" id="Editbox1" name="date" value="" tabindex="1" autocomplete="off" placeholder="Date">
         <table id="Table1">
            <tr>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-toggle-off">&nbsp;</i>Mode de r&#232;glement</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0082.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Mode de règlement</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
