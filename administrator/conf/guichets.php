...
<link href="../../css/guichets.css" rel="stylesheet">
</head>
<body>
   <div id="container">
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <label for="" id="Label2">Base de données -Guichets</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <hr id="Line1">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste des Guichets existants</h1></div>
         </div>
         ...
         <input type="text" id="guichetsEditbox1" name="agence" value="" tabindex="1" placeholder="Agence">
      </form>
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-train">&nbsp;</i>Guichets</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0079.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Guichets</label>
      </div>
   </div>
</body>
</html>