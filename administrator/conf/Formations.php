...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <label for="" id="Label2">Base de données - Formations</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <input type="text" id="Editbox4" name="typr" value="" tabindex="1" placeholder="Type formation">
         <input type="text" id="Editbox5" name="date" value="" tabindex="1" placeholder="Date fin">
         <input type="text" id="Editbox1" name="date1" value="" tabindex="1" placeholder="Date d&#233;but">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste des formations existantes</h1></div>
            <hr id="Line1">
         </div>
         <table id="Table1">
            <tr>
            ...
            <tr>
               ...
               <td class="cell2"><span id="wb_uid15"> </span></td>
               <td class="cell2"><span id="wb_uid16"> </span></td>
               <td class="cell3"><span id="wb_uid17"> </span></td>
            </tr>
            <tr>
            ...
            <tr>
               <td class="cell4"><span id="wb_uid36"> </span></td>
               <td class="cell4"><span id="wb_uid37"> </span></td>
               <td class="cell4"><span id="wb_uid38"> </span></td>
               <td class="cell4"><span id="wb_uid39"> </span></td>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-ravelry">&nbsp;</i>Formations</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0067.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Formations</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
