...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="promotion" value="" tabindex="1" placeholder="Promotion">
         <label for="" id="Label2">Base de données - Promotions</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste des Promotions existantes</h1></div>
            <hr id="Line1">
         </div>
         <input type="text" id="Editbox5" name="typepromotion" value="" tabindex="1" placeholder="Type promotion">
         <table id="Table1">
            <tr>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-user-md">&nbsp;</i>Promotions</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0055.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Promotions</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
