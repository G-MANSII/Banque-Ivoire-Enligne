...
<link href="../../css/Villes.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <label for="" id="Label2">Base de données - Villes</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste des Villes existantes</h1></div>
            <hr id="Line1">
         </div>
         <table id="Table1">
            <tr>
         ...
         <input type="text" id="Editbox5" name="ville" value="" tabindex="1" placeholder="Ville">
         <input type="text" id="Editbox6" name="geo" value="" tabindex="1" placeholder="Situation geographique">
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-medium">&nbsp;</i>Villes</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0058.png" id="Shape2" alt=""></div>
