...
<link href="../../css/Type_de_contrats.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="contrat" value="" tabindex="1" placeholder="Contrat">
         <label for="" id="Label2">Base de données - Type 
de contrats</label>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-leanpub">&nbsp;</i>Types de contrats</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0057.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Types de contrats</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
