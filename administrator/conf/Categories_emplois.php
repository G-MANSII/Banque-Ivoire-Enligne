...
<link href="../../css/Categories_emplois.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <label for="" id="Label2">Base de données - Categories emplois</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <hr id="Line1">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste des catégories emplois existants</h1></div>
         </div>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-ticket">&nbsp;</i>Categories emplois</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0080.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Categories emplois</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
