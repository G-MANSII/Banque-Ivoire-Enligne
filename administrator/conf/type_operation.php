...
<head>
<meta charset="utf-8">
<title>Categorie Opérations</title>
...
<link href="../../css/type_operation.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         ...
         <label for="" id="Label2">Base de données - Type opérations</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <hr id="Line1">
            <div id="wb_Heading1">
               <h1 id="Heading1">ListeType opérations existants</h1></div>
         </div>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-codepen">&nbsp;</i>Type op&#233;rations</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0086.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Type opérations</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
