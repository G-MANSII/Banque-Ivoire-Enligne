...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="Nom" value="" tabindex="1" placeholder="Nom du service">
         <label for="" id="Label2">Base de données - Services</label>
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-map-signs">&nbsp;</i>Services</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0056.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Services</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
