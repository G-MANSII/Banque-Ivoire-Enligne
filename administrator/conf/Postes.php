...
<link href="../../css/Postes.css" rel="stylesheet">
...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <input type="text" id="edtlogin" name="Nom" value="" tabindex="1" placeholder="Nom poste">
         <label for="" id="Label2">Base de données - Postes</label>
         <input type="submit" id="btnconnexion" name="Ajouter" value="Ajouter">
         <div id="Layer3">
            <hr id="Line2">
            <div id="wb_Heading1">
               <h1 id="Heading1">Liste des Postes existants</h1></div>
            <hr id="Line1">
         </div>
         <input type="text" id="Editbox1" name="departement" value="" tabindex="1" placeholder="D&#233;partement">
         <table id="Table1">
            <tr>
         ...
         <input type="date" id="Editbox2" name="date" value="" tabindex="1" autocomplete="off" placeholder="Date d&#39;ajout">
      </form>
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-meetup">&nbsp;</i>Postes</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../../images/img0054.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Postes</label>
      </div>
      <div id="Divi">
         <div id="head">
            <div id="wb_band">
