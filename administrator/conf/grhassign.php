...
<body>
   <div id="container">
      ...
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <label for="" id="Label2">Base de données - GRH assigné</label>
         <div id="Layer4">
            <div id="wb_Text7">
         ...
         <div id="Layer7">
            <div id="wb_Text29">
               <div id="wb_uid18"><span id="wb_uid19"><strong><u>Informations de connexion</u></strong></span></div>
            </div>
            <input type="text" id="Editbox1" name="login" value="" tabindex="2" placeholder="Login*">
            <input type="password" id="Editbox24" name="motdepasse" value="" tabindex="2" placeholder="Mot de passe*">
            <input type="password" id="Editbox2" name="motdepassconfirmer" value="" tabindex="2" placeholder="Confirmer mot de passe*">
            <div id="wb_Text24">
               <span id="wb_uid20">Choisir un login. Minimum 4 caractères.</span></div>
            <div id="wb_Text25">
               <span id="wb_uid21">Choisir un mot de passe. Minimum 8 caractères contenant minimum, majuscule, et alphanumérique.</span></div>
         </div>
         <div id="Layer6">
            <div id="wb_Text21">
               <div id="wb_uid22"><span id="wb_uid23">Pièces d'identification:</span></div>
            </div>
            <div id="wb_Text23">
               <div id="wb_uid24"><span id="wb_uid25"><strong><u>Documents à fournir</u></strong></span></div>
            </div>
            <input type="file" id="FileUpload1" name="piece">
            <input type="file" id="FileUpload3" name="cv">
            <div id="wb_Text2">
               <div id="wb_uid26"><span id="wb_uid27">Curriculum Vitae</span></div>
            </div>
            <div id="wb_Text19">
