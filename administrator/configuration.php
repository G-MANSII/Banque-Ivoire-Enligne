   ...
   <div id="container">
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-sitemap">&nbsp;</i>Configuration</li>
         </ul>
      </div>
      <form name="Layer1" method="post" action="" enctype="text/plain" id="Layer1">
         <label for="" id="Label2">Selectionner la modification a faire</label>
         <input type="submit" id="btnconnexion" name="Configurer" value="Connexion">
         <select name="Combobox1" size="1" id="Combobox1">
            <option selected="" value="gsgt">qgsq</option>
            <option>ezéa</option>
            <option value="qh">rthh</option>
         </select>
         <div id="wb_Form1">
            <form name="vfd" method="post" action="./../connexion/connexion.html" enctype="text/plain" id="Form1">
               <label for="Combobox2" id="Label1">New Label:</label>
               <select name="Combobox2" size="1" id="Combobox2">
                  <option value="aaaaaaaaaaaa">aaaaaaaaaaaaa</option>
                  <option value="bbbbbbbbbbbbbb">bbbbbbbbbb</option>
                  <option value="cccccccccccccccc">cccccccccccccccccccc</option>
               </select>
      ...
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../images/img0055.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Configuration</label>
      </div>
      <div id="wb_Shape1">
         <a href=""><div id="Shape1"><div id="Shape1_text"><span id="wb_uid4"><strong>Connexion</strong></span></div></div></a>
      </div>
   </div>
<script src="../java-script/configuration.js"></script>
</body>
</html>