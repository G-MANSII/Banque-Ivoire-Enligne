...
<script src="../java-script/jquery.ui.datepicker-fr.js"></script>
<script>   
...
de contrats</option>
      ...
      <div id="Divi">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid16"><span id="wb_uid17"><a href="./../agences/">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
               <div id="icolocal"><i class="fa fa-map-marker">&nbsp;</i></div></div>
            <div id="wb_txtacc">
               <div id="wb_uid18"><span id="wb_uid19"><em>La banque en ligne faite pour vous&nbsp;!</em></span></div>
            </div>
            <div id="wb_logo">
