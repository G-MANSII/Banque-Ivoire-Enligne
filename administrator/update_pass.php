   ...
   <div id="container">
      ...
      <div id="wb_Breadcrumb2">
         <ul id="Breadcrumb2">
            ...
            <li class="active"><i class="fa fa-unlock">&nbsp;</i>Changer mot de passe</li>
         </ul>
      </div>
      <div id="Layer2">
         <div id="wb_Shape2">
            <img src="../images/img0035.png" id="Shape2" alt=""></div>
         <label for="" id="Label3">Changer de mot de passe</label>
      </div>
   </div>
<script src="../java-script/update_pass.js"></script>
</body>
</html>