   ...
   <div id="container">
      ...
      <div id="zone">
         <div id="Slider">
            ...
            <img class="image" src="images/im-B000672_hp-billboard_965x325.FINAL.ReachforGreat_new.jpg" id="wb_uid0" alt="" title="">
            <img class="image" src="images/OFFR.png" id="wb_uid1" alt="" title="">
            <img class="image" src="images/Prize.jpg" id="wb_uid2" alt="" title="">
         </div>
         <div id="divhg">
            <div id="wb_btn_connexacei">
               <a href="https://webmail.hostinger.fr"><div id="btn_connexacei"><div id="btn_connexacei_text"><span id="wb_uid3"><strong>Connexion</strong></span></div></div></a></div>
            <div id="wb_btn_inscriptiacei">
               <a href="./incription/"><div id="btn_inscriptiacei"><div id="btn_inscriptiacei_text"><span id="wb_uid4"><strong>Inscription</strong></span></div></div></a></div>
            <div id="wb_txt_AC">
               <div id="wb_uid5"><span id="wb_uid6">Connectez vous et gérez </span></div>
               <div id="wb_uid7"><span id="wb_uid8">votre compte&nbsp;!</span></div>
            </div>
            <div id="wb_txtpass">
               <div id="wb_uid9"><span id="wb_uid10">Mot de passe oublier&nbsp;?</span></div>
            </div>
            <div id="wb_txtins">
               <div id="wb_uid11"><span id="wb_uid12">Vous avez pas de compte&nbsp;? </span></div>
      ...
      <div id="divhead">
         <div id="head">
            ...
            <div id="wb_local">
               <div id="wb_uid51"><span id="wb_uid52"><a href="./index1.php">Banque prêt de chez vous&nbsp;!</a></span></div>
            </div>
            <div id="wb_icolocal">
